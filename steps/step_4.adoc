...
Key store used in step 2 is reused in this step for both integrity and confidenciality.
...
Please see the technical specifications part of step 2 for complete technical specification in this step.
